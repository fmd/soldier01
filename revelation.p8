...
function do_enemy1_ai(actor)
  ...
  -- if we find blood prints, follow. else, go clockwise.
  actor.act.d = actor.facing
...
function act_pos(actor)
  ...
  if (actor.act.a != 0x00 or is_wall(test_point)) return actor_point
...
function attempt_melee(actor)
  ...
  if (h) then
    ...
    if (moving_out_point.x == attack_point.x and moving_out_point.y == attack_point.y) stun_actor(h)
    return
  end
  if (w) then
    stun_actor(w)
...
function stun_actor(actor)
  actor.stunned_turns = 3
end
...
function sprite_for(actor)
  ...
  if (turn_start != nil) then
    if (actor.act.a != 0x00) return sprites[actor.pattern][actor.facing+1][7]
...
function _draw()
  ...
  camera(0, 0)
  draw_ui()
  -- print(turn .. "t" .. frame .. "f" .. player_action.d .. "d " .. player_action.a .. "a", 0, 5, 11)
end
__gfx__
...

__sfx__
