...
-- introduce blood footprint mechanic
...
-- level data
levels = {{3, 25, 13, 7}, {3, 20, 9, 5}, {28,13,13,9}, {0,10,13,9}, {13,9,12,12}, {11,0,9,6}, {20,0,6,8}, {0,0,11,10}, {26,0,22,16}} -- xstart, ystart, w, h
level_items = {{}, {}, {}, {}, {}, {"socom"}, {}, {"c4"}, {}}
level_enemy_variants = {{2,2,1,2,1}, {1,1}, {2,2,2,2}, {1,2,1}, {2,1,2}, {2,2}, {2,2}, {1,1,1,1,2}, {2,2,2,2,2,2,2,2,2,2,2,2,2}}
...
function do_enemy1_ai(actor)
  ...
  if (printed) then
    ...
    tiles = collect_tile_line(actor, actor.act.d)
  ...
  tiles = collect_tile_line(actor, prev_facing)
...
function collect_tile_line(actor, d)
  collected = {}
...
function attempt_shot(actor)  
  for i, tile in pairs(collect_tile_line(actor, actor.act.d)) do
    hurts = {}
...
function draw_lasers()
  for actor in all(actors) do
    if (actor.act.a == 0x01) then
      for tile in all(collect_tile_line(actor, actor.act.d)) do
...

...

...

...

...
00000000510000156777767767606066677677771067776777776001677677601067776700060676766760018222222929292828b33333333993883b00000000
...

...

...

__sfx__
