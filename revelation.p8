...
-- level data
levels = {{0,10,13,9}, {13,9,10,12}, {11,0,9,6}, {20,0,5,5}, {0,0,11,10}} -- xstart, ystart, w, h
...
function attempt_shot(actor)  
  for i, tile in pairs(collect_tile_line(actor)) do
    ...
    for j, a in pairs(actors) do
      ap = act_pos(a)
      if (actor != a and ((a.pos.x == tile.x and a.pos.y == tile.y) or (ap.x == tile.x and ap.y == tile.y)) and actor.life > 0) then 
        add(hurts, a)
      end      
    end
...

...

