...
function _update()
  ...
  if ((player_action.d > -1 and d == -1) or (player_action.a == 0x10)) then
    if (player_action.a != 0x10) start_turn(); return
    attempt_swap()
  end
  update_idle()
end
...
function draw_c4_placement()
  if (idle_start != nil and player_action.a == 0x01 and player_action.d > -1 and equipped == "c4") then
    ap = to_pos(player_action.d)
    fp = {x = player.pos.x + ap.x, y = player.pos.y + ap.y}
...

...

