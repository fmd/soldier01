...
level_keycards = {{1,2}}
level_keydoors = {{1,2}}
level_enemy_variants = {{3,1,2,1,3,3,3,1,1,2,3,2,3,2,1,3,3,1,1}}
  ...
  for r in all(relays) do
    if (cmp_pos(player.pos, r.pos) and player.life > 0) then
      if (r.active == 0) then
        ...
        prev_inventory["socom"] = inventory["socom"]
        prev_inventory["c4"] = inventory["c4"]
        prev_inventory["gloves"] = inventory["gloves"]
...
function take_input()
  ...
  if (btn(4) and btn(5) and turn > 0) then
    if (not restarting) restart_time = time()
    restarting = true
    if (time() - restart_time >= 3) restarting = false; load_level(level); return
  else
    restarting = false
  end
...
function _update()
  if (player.life <= 0) then
    if (btn(4) and btn(5)) load_level(level); return
    do_turn()
    return
  end
...
function draw_restart_ui()
  if (temp_action == nil) return
  if (idle_start != nil and btn(4) and btn(5) and turn > 0) then
...

...

...

